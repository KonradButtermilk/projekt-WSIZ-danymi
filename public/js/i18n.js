...
const translations = {
  ...
  pl: {
    ...
    'vocab.subtitle': 'Przegląd zapisanych fiszek i słów',
    'vocab.add': '+ Dodaj nowe słowo',
    'vocab.save': 'Zapisz',
    'vocab.empty': 'Wszystko nadrobione! Brak słów do powtórki.',
    'vocab.due': 'Liczba fiszek do powtórki: {count}',
    'vocab.show': 'Pokaż Odpowiedź',
    'vocab.how_well': 'Poziom zapamiętania:',
    'vocab.forgot': 'Zapomniane (0)',
    'vocab.hard': 'Trudne (2)',
    'vocab.good': 'Dobre (4)',
    'vocab.perfect': 'Idealne (5)',
